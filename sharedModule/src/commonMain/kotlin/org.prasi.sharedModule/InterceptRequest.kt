...
@Composable
internal fun InterceptRequest(navHostController: NavHostController? = null) {
    ...
    val navigator =
        rememberWebViewNavigator(
            requestInterceptor =
            object : RequestInterceptorInterface {
                override fun onInterceptUrlRequest(
                    ...
                    return if (request.url.contains("kotlin")) {
                        WebRequestInterceptResultInterface.Modify(
                            WebRequest(
                        ...
                        WebRequestInterceptResultInterface.Allow
                    }
                }
            },
        )
